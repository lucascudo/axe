...
{ filename: 'a confianca e o adubo.mp3', description: '' },
...
{ filename: 'a maior felicidade de toda mae.mp3', description: '' },
{ filename: 'a maior surpresa da vida.mp3', description: '' },
...
{ filename: 'a sapiencia so pode ser encontrada.mp3', description: '' },
{ filename: 'a sobrevivencia e a maior de todas.mp3', description: 'A sobrevivência é a maior de todas as vitórias.' },
{ filename: 'a unica certeza que a idade nos tras.mp3', description: '' },
...
{ filename: 'bom dia.mp3', description: '' },
{ filename: 'cabe a cada um saber.mp3', description: 'Cabe a cada um saber o quanto dói a sua dor.' },
{ filename: 'competir e lutar sem intencao.mp3', description: '' },
{ filename: 'competir e mostrar seu potencial e saber aplaudir.mp3', description: '' },
...
{ filename: 'em nada adianta a indignacao.mp3', description: '' },
{ filename: 'em um podio.mp3', description: '' },
{ filename: 'encontrar o amor verdadeiro.mp3', description: '' },
{ filename: 'livre e quem respeita.mp3', description: '' },
{ filename: 'nao e bom chorar muito.mp3', description: '' },
...
{ filename: 'ninguem deve afirmar.mp3', description: '' },
...
{ filename: 'não esperem que um bufalo.mp3', description: 'Não peçam ao búfalo que voe como uma borboleta e nem espere que a borboleta tenha a força de um búfalo.' },
...
{ filename: 'o destino tacado e o caminho.mp3', description: '' },
...
{ filename: 'o medo e a arma invisivel.mp3', description: '' },
...
{ filename: 'quando fechamos os olhos para o mundo.mp3', description: '' },
...
{ filename: 'rejeitar a dor e rejeitar a vida.mp3', description: '' },
...
{ filename: 'se todas as lagrimas.mp3', description: '' },
...
{ filename: 'seu destino esta escrito na linha dos seus sonhos.mp3', description: '' },
{ filename: 'so e brincadeira aquilo.mp3', description: '' },
{ filename: 'sobreviver e a maior vitoria na guerra.mp3', description: 'Sobreviver é a maior vitória na guerra do viver.' },
{ filename: 'tenha piedade dos outros mas evite.mp3', description: '' },
{ filename: 'todo mundo procura o amor mas so encontra.mp3', description: '' },
...
{ filename: 'xire e o verbo brincar.mp3', description: '' }
  ].sort(function () {
